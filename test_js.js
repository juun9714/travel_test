...
const result_list={
    ISTP:{
        ...
        character:"당신은 효율성을 최고의 가치로 생각하시는군요! 그래서 짜여진 계획을 고수하기보단 융통성 있게 해결해 나가는 편입니다 또한 가장 효율적으로 문제를 해결하는 것을 마치 게임처럼 즐길 때도 있으시군요! 모험과 스릴을 즐기고 임기응변에 강한 모습을 보여줄 때도 있는데요. 평소에는 조용한 모습으로 있다가도 아드레날린이 솓구치는 상황을 내심 기대하고 계시네요! 그렇지만 여행의 전체가 모험과 스릴로 가득하다면 극심한 피로감에 시달리기 때문에 쉴 때는 확실히 쉬어주어야해요",
        location:"호주 시드니",
    ...
    ENTJ:{
        ...
        character:"나서서 이끌어 가는걸 좋아한다기보다는 다른 사람들이 하는게 맘에 들지 않아서 나서게 되는군요. 이것만 끝나면…이번만 지나면…하고 다짐하지만 자기도 모르게 버스기사가 되어있는 모습을 발견하기도 합니다.여행에서만큼은 조금 내려놓아보는건 어떨까요? 오로지 휴식만을 생각하는거에요. 우리나라와 문화, 정서적으로 많이 다른 유럽의 한 도시에서, 적당한 거리감을 유지한 채 휴식을 즐겨보세요",
        location:"스페인 발렌시아",
    ...
    ISFJ:{
        ...
        character:"여행을 떠날때 꼼꼼하게 짜인 일정이 없으면 안된다고 생각하는 당신! 특유의 책임감을 바탕으로 함께 여행을 떠나는 이들의 의견을 모아 구체적인 계획과 일정을 세우길 좋아하는군요! 뿐만 아니라, '무슨 일이 벌어질지 몰라!' 이것도 챙기고, 저것도 챙기고. 여행을 갈 때 누구보다 많은 짐을 가지고 가는군요! 누구보다 당신의 계획에 잘 따라주고 즐거워할 동료와 함께 여행을 떠난다면 더할 나위 없이 즐겁게 여행을 할 수 있을 거에요!",
        location:"스위스",
    ...
    INFP:{
        ...
        character:"당신은 세세하게 짜인 계획에 따르는 여행보다 큼직한 일정을 중심으로 융통성 있고 즉흥적인 여행을 즐기시는 스타일이군요! 여행 일정에 구애받아 이동 중 마음에 꽂힌 장소를 방문하지 못하고, 분 단위로 일정을 짜느라 고통받는 경우에 '이렇게 까지 해야하나..' 싶어 할 수도 있어요! 그러다보니 분 단위의 세세한 계획을 짜기보단 꼭 가야 할 곳 정도를 정하는 등 도움을 주는 역할을 하는 게 편할 수 있어요. 본격적으로 계획을 짤 때 가고 싶은 곳을 말하면 이를 조합해 융통성 있으면서도 완벽한 계획으로 만들어주는 스타일의 친구와 함께한다면 편히 여행을 할 수 있지 않을까요? 당신이 하고싶은 것을 놓치지 않도록 신경쓰며 융통성 있는 일정을 바탕으로 즐거운 여행을 만들어 줄 수 있는 친구와 여행한다면 좋을거에요!",
        location:"뉴질랜드",
    ...
    INFJ:{
        ...
        character:"계획을 세우는 것 자체를 좋아하기 때문에 여행을 떠날 때에도 일찍부터 굵직한 여행지들을 알아보곤 하는군요! 더구나 '이왕 가는 여행, 의미 없는 여행이 되어선 안돼!'라는 생각으로 만반의 준비를 기하곤 하겠네요! 여행지에서 경험할 수 있는 모든 것을 최대한 즐기는 것을 좋아하는 동행자와 함께 여행한다면 분명 '하얗게 불태우'고 돌아오고 나서도 아쉬움은 최소로 줄일 수 있는 즐거울 여행을 할 수 있을거에요!",
        location:"캐나다",
    ...
    ENFP:{
        ...
        character:"새로운 여행지에서 요즘 유행하는 액티비티, 핫플은 다 경험해봐야지 만족하는 스타일이에요. 할 것은 많은데 계획 짜는 것 자체를 귀찮게 느껴서 비행기 타기 직전까지 무계획일 가능성이 크군요!  하지만 친구들과 함께하는 여행에서는 총대를 메고 여행계획부터 총무까지 도맡아서 모두가 만족하는 여행을 만들어 가는 스타일이에요!",
    ...
    ISFP:{
        ...
        character:"사람이 많은 곳에 가면 지치는 스타일이에요. 유명한 관광지에 방문한 뒤에는 공원이나 카페에서 잠깐 쉬어주어야 해요! 혼자 여행을 떠나 나만의 시간을 확보하는 것이 더 편할거에요. 하지만 친구와 함께 여행을 가더라도 타고난 배려심 덕분에 즐거운 추억들을 가지고 올 수 있을거에요!",
        location:"오스트리아 빈",
    ...
    INTP:{
        ...
        character:"무언가에 몰두해 있는 시간이 많은 만큼 혼자가는 여행이라도 외롭지 않아요. 오히려 사색에 빠져 시간가는 줄 모를 거예요. 새로운 곳에서 새로운 사람들을 만나는 것을 선호하는 편은 아니군요. 하지만 우연히 만난 사람이 관심사가 똑같다면, 금방 친해져 대화에 푹 빠져 심심함을 느낄 틈이 없을거에요!",
        location:"몽골",
    ...
    ENFJ:{
        ...
        character:"당신은 소중한 사람들과 소중한 시간을 함께 보내는 여행을 좋아하시군요. 또한 계획을 열심히 짜고 그 계획을 좋아하고 지지해주는 친구와 함께하면 여행의 피로는 저 멀리 사라지는 편이시겠네요. 친구들과 갈등을 피하기 위해 노력을 많이 하기도 하고, 남들이 즐거워하는 지 계속 생각하는 시간도 많을 거에요. 가끔은 본인이 하고 싶은 것을 해보는 것도 중요해요!",
        location:"이탈리아 로마",
    ...
    INTJ:{
        ...
        character:"당신은 독립심이 강하고 목표지향적인 사람이기에 여행에서도 효율적인 것은 빼놓을 수 없는 부분이에요. 관심 있는 것에는 몰두하지만, 그 밖에 것에는 흥미가 생기지 않기에, 본인이 선택한 여행계획대로 흘러가는 것이 편할 거에요. 사실은 계획이 틀어지는 것을 싫어하는 것이기도 하지요. 혼자 캐리하는 경향이 있는데, 조용히 잘 서포트해주는 친구와 함께 한다면 혼자만큼 좋은 여행이 될거에요.",
        location:"미국 캘리포니아",
    ...
    ESTP:{
        ...
        character:"개방성을 바탕으로 머리 아프게 고민하는 것보다 마음이 이끄는 대로 행동하는  것을 즐기는 편이시네요. 또한 사람을 좋아해 처음 만난 사람들과도 상대적으로 빨리 친해지는 성격이기에, 매력적인 사람을 많이 만날 수 있는 여행지가 어울려요. 살짝 꼼꼼하게 챙겨줄 수 있는 친구와 함께 한다면 더욱 편안한 여행을 할 수 있을거에요.",
        location:"러시아 시베리아",
